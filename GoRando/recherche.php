...
if (!empty($lieu) && !empty($date) && !empty($lieu_depart)) {
    $req = "SELECT * FROM `rando_proposee` WHERE `lieu` LIKE '$lieu' AND `date` = '$date' AND `lieu_depart` LIKE '$lieu_depart' ";
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);


} else if (!empty($lieu) && !empty($date) && empty($lieu_depart)) {

    $req = " SELECT * FROM `rando_proposee` WHERE `lieu` LIKE '$lieu' AND `date` = '$date' ";
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);
    ...
    $req = "SELECT * FROM `rando_proposee` WHERE `lieu` LIKE '$lieu' ";
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);
    ...
    $req = "SELECT * FROM `rando_proposee` WHERE `date` = '$date' ";
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);
    ...
    $req = "SELECT * FROM `rando_proposee` WHERE `lieu_depart` LIKE '$lieu_depart' ";
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);
    ...
    $req = " SELECT * FROM `rando_proposee` WHERE  `date` = '$date' AND `lieu_depart` LIKE '$lieu_depart'  ";
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);
    ...
    $req = " SELECT * FROM `rando_proposee` WHERE  `lieu` = '$lieu' AND `lieu_depart` LIKE '$lieu_depart'  ";
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);
    ...
    $req = " SELECT * FROM `rando_proposee`" ;
    $rep = $dbConnect->query($req);
    $result = $rep->fetchAll(PDO::FETCH_ASSOC);
}
